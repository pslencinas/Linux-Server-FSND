...
We are deploying a flask application on to AWS Light Sail.  This document will give you steps from creating your instance to your application.
...
sys.path.insert(0, '/var/www/catalogItemFSND')
...
<VirtualHost *:80>
     ...
     WSGIScriptAlias / /var/www/catalogItemFSND/itemsCatalog.wsgi
     #Allow Apache to serve the WSGI app from our catalog directory
     <Directory /var/www/catalogItemFSND>
          Order allow,deny
          Allow from all
     </Directory>
     #Allow Apache to deploy static content
     <Directory /var/www/catalogItemFSND/static>
        Order allow,deny
        Allow from all
     </Directory>
...
```
mkdir catalogItemFSND
cd /var/www/catalogItemFSND

sudo git clone https://github.com/pslencinas/catalogItemFSND.git  catalogItemFSND
```
